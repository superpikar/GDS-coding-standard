 ...
 */
class JDS_Sniffs_Commenting_ClassVariableCommentSniff extends JDS_Sniffs_Commenting_FunctionCommentSniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $arrayFind = array(
            ...
            'docBlockType' => 'class variable',
        );
        $arrayExcludeRegister = array(T_FUNCTION, T_DOC_COMMENT );

        $this->processForAsperand($phpcsFile, $stackPtr, $arrayFind, $arrayExcludeRegister);
