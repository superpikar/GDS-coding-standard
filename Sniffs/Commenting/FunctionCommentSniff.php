...
class JDS_Sniffs_Commenting_FunctionCommentSniff extends PEAR_Sniffs_Commenting_FileCommentSniff
{
    ...
    protected $arrayExcludeRegister = array();
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $this->arrayExcludeRegister = null ;

        $this->processForAsperand($phpcsFile, $stackPtr, $arrayFind);

    }

    protected function processForAsperand(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $arrayFind, $excludeRegister = null)
    {
        $find = array_replace(array(), $arrayFind['find']);
        ...
        // if token found is not in exlude from regiter
        // example we want to exlude "function" wherze PHP_CodeSniffer detect "protected function", so "protected function" will not be checked
        if(!is_null($excludeRegister))
        {
            if(in_array($code, $excludeRegister))
            {
                return ;
            }
        }
        ...
        $this->processAnotherTags($commentStart, $commentEnd, $arrayFind['docBlockType'], $this->secondTags);
    }
     ...
     */
    protected function processAnotherTags($commentStart, $commentEnd, $docBlockType, $arrayTags)
    {
